...
BEGIN
  ...
  TUI.PutStr(1, 0, "Chess Attack (5x6)  [Tab=Move list]  [Ctrl-Q=Quit]", TUI.Yellow, TUI.Black);
...
BEGIN
  ...
  TUI.ClearBack(TUI.White, TUI.Black);
  TUI.PutStr(1, 0, "Chess Attack (5x6)  [Tab=Board view]  [Ctrl-Q=Quit]", TUI.Yellow, TUI.Black);
