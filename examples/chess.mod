...
BEGIN
  ...
  TUI.PutStr(0, 0, "Chess  [Tab=Move list]  [Esc=Quit]", TUI.Yellow, TUI.Black);
...
BEGIN
  TUI.ClearBack(TUI.White, TUI.Black);
  TUI.PutStr(0, 0, "Chess  [Tab=Board view]  [Esc=Quit]", TUI.Yellow, TUI.Black);
